...
parser.add_argument('--save_video', type=str2bool, default=False, help='save video if true')
parser.add_argument('--use_ignore', type=str2bool, default=True, help='use ignore or not')
